$(document).ready(function(){
    ...
    console.log(queryString.get('Title'));
  ...
  var getImage = function(query,pl){
    $.post('query.php', { query: query }, function (res) {//switch to query.php
        ...
        if(res == '[]'){
            ...
            // var image = document.getElementById("personImage1");
